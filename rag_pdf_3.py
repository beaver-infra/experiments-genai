...
# Constants
PERSIST_DIR_SENTENCE = "./rag_pdf_3/sentence_index"
PERSIST_DIR_BASE = "./rag_pdf_3/base_index"
...
sentence_index = VectorStoreIndex.from_documents(
  ctx_sentence, storage_context=storage_context
)
base_index = VectorStoreIndex.from_documents(
  ctx_base, storage_context=storage_context
)
